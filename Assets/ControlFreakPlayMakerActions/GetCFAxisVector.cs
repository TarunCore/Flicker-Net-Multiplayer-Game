...
public class GetCFAxisVector : FsmStateAction
{
	...
	[Tooltip("The name of the horizontal input axis. See the CFInput class.")]
	public FsmString
		horizontalAxis;
	[Tooltip("The name of the vertical input axis. See the CFInput class.")]
	public FsmString
		verticalAxis;
	...
	public override void OnUpdate ()
	{
		...
		var h = (horizontalAxis.IsNone || string.IsNullOrEmpty (horizontalAxis.Value)) ? 0f : CFInput.GetAxis (horizontalAxis.Value);
		var v = (verticalAxis.IsNone || string.IsNullOrEmpty (verticalAxis.Value)) ? 0f : CFInput.GetAxis (verticalAxis.Value);
